...
import com.jwell.suite.app.BaseApplication;

public class Dlog {

    static final String TAG = "Jwell Scan";
    ...
    public static final void i(String nTAG,String message) {
        if (BaseApplication.DEBUG)Log.i(nTAG, buildLogMsg(message));
    }
    /** Log Level Debug **/
    public static final void d(String message) {
        if (BaseApplication.DEBUG)Log.d(TAG, buildLogMsg(message));
    }
    public static final void d(String nTAG, String message) {
        if (BaseApplication.DEBUG)Log.d(nTAG, buildLogMsg(message));
    }
